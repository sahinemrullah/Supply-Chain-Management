...
--
-- Table structure for table `order_m_d_d`
--

DROP TABLE IF EXISTS `order_m_d_d`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_m_d_d` (
  `order_m_d_d_id` int NOT NULL AUTO_INCREMENT,
  `order_m_d_id` int NOT NULL,
...
--
-- Dumping data for table `order_m_d_d`
--
