...
@WebServlet(name = "ProductListServlet", urlPatterns = {"/tedarikci/urunlerim"})
public class ProductListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Response result = HttpRequestUtils.get("http://localhost:9080/retailer/myProducts", parameters, token);
