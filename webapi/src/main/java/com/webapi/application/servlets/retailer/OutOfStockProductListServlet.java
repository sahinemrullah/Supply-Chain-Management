...
@WebServlet(name = "OutOfStockProductListServlet", urlPatterns = {"/retailer/outOfStockProducts"})
public class OutOfStockProductListServlet extends HttpServlet {
    ...
    public OutOfStockProductListServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PaginatedListModel<ProductListModel> model = productRepository.getProductsOutOfStockFor(retailerId, pageNumber, 10);
