...
@WebServlet(name = "PendingOrdersServlet", urlPatterns = {"/retailer/orders"})
public class PendingOrdersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PaginatedListModel<PendingOrderModel> model = orderRepository.getPendingOrders(retailerId, pageNumber, 10);
